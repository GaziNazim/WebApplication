<%@ Page Language="C#" AutoEventWireup="true" CodeFile="People.aspx.cs" Inherits="Pages_People" %>
        ...
        <div class="main">
            ...
            <div class="left_col">
                ...
                <div class="profile">
                    ...
                    <div class="pro_name">
                         <asp:Label ID="Label1" runat="server" Text="Nagim Gazi" style="font-weight: 700;font-size:30px; font-style: italic;"></asp:Label>
                    </div>
            ...
            <!-- Left column End -->
             ...
             <!-- Mid column start -->
            <div class="mid_col">
                <asp:Label ID="Label3" runat="server" Text="People" style="font-size:40px;margin:10px 235px "></asp:Label>
               <div style="width:inherit;height:1px;background:white;margin-top:18px"></div>
                <asp:DataList id="ItemsList" runat="server" style="margin-left: 185px">
         <ItemTemplate >
              <table class="auto-style2">

                  <tr>
                   <td > <%# DataBinder.Eval(Container.DataItem, "name") %> </td>
                <td  style="text-align:right"><asp:Button Text="Add as friend" ID="Button1" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "username") %>' 
