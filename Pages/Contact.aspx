    ...
    <form id="form1" runat="server">
        <div class="main">
            ...
            <!-- Left column End -->
             ...
             <!-- Mid column start -->
            <div class="mid_col">
                <asp:Label ID="Label3" runat="server" Text="Request" style="font-size:40px;margin:10px 235px "></asp:Label>
         ...
         <ItemTemplate >
              <table class="auto-style2">
                ...
                <td  style="text-align:right"><asp:Button Text="Confirm As Friend" ID="Button1" CommandArgument='<%# DataBinder.Eval(Container.DataItem, "username") %>' 
